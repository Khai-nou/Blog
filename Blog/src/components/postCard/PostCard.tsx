    ...
    <div className={styles.container}>
      <div className={styles.cardBody}>
        <div className={styles.imageWrapper}>
          {props.image ? <img className={styles.image} src={props.image} alt="Image" /> : null}
        </div>
        <p className={styles.date}>{props.date}</p>
        <Link to={`/posts/${props.id}`}><h3 className={styles.title}>{props.title}</h3></Link>
      </div>
      <div className={styles.footer}>
        <div className={styles.rate}>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
